...
const Card = ({ member }: { member: TeamMember }) => (
    <div className="overflow-hidden rounded-lg bg-white shadow-md transition-shadow duration-300 hover:shadow-xl">
        <div className="h-1 bg-gradient-to-r from-yellow-400 via-yellow-400 to-gray-800" />
        <div className="flex flex-col items-center p-6 text-center">
            ...
            <div className="relative inline-block">
                ...
                <div className="absolute bottom-0 left-1/2 h-0.5 w-12 -translate-x-1/2 transform bg-yellow-400" />
            </div>
        </div>
    </div>
);

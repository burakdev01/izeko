...
interface HeroSlideEditProps {
    slide: HeroSlide;
}

export default function HeroSlideEdit({ slide }: HeroSlideEditProps) {
    const { data, setData, put, processing, errors } = useForm<HeroSlideFormData>(
        {
            title: slide.title ?? '',
    ...
    return (
        <AdminLayout
            title="Hero Slide Duzenle"
            description="Slider kaydini guncelleyin."
        >
            <Head title="Hero Slide Duzenle" />
            <form

...
type BoardMembersIndexProps = {
    members: BoardMember[];
};

const placeholderImage = 'https://via.placeholder.com/96?text=Uye';

export default function BoardMembersIndex({ members }: BoardMembersIndexProps) {
    const {
        orderedItems,
        draggedId,
        handleDragStart,
        ...
        items: members,
        reorderUrl: '/admin/board-members/reorder',
    });

    return (
        <AdminLayout title="Yönetim Kurulu">
            <Head title="Yönetim Kurulu" />

            <div className="space-y-6">
                <div className="rounded-2xl border border-gray-200 bg-white shadow-sm">
                    <AdminPageHeader
                        title="Yönetim Kurulu"
                        description="Yönetim kurulu üyelerini yönetin ve sırasını değiştirin."
                        actionLabel="Yeni Üye Ekle"
                        actionHref="/admin/board-members/create"
                    />
                            ...
                            <tbody className="divide-y divide-gray-200">
                                ...
                                {orderedItems.map((member) => (
                                    ...
                                    >
                                        ...
                                        <td className="px-6 py-4">
                                            <AdminRowActions
                                                editHref={`/admin/board-members/${member.id}/edit`}
                                                deleteHref={`/admin/board-members/${member.id}`}
                                            />
                                        </td>
                                    </tr>
                                ))}

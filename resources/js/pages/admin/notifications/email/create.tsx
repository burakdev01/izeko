...
export default function EmailCreate({ users, offices }: EmailCreateProps) {
    ...
    return (
        <AdminLayout title="Yeni Email Gönder">
            <Head title="Yeni Email Gönder" />

            <form onSubmit={submit} className="space-y-6">
                <AdminFormHeader
                    title="Yeni Email Gönder"
                    description="Kullanıcılara veya ofislere toplu email gönderin."
                    submitLabel="Gönder"
                    cancelHref="/admin/bildirimler/email"

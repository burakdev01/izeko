...
import { AlertCircle, CheckCircle, Megaphone, Search } from 'lucide-react';
...
type PushNotificationsIndexProps = {
...
export default function PushNotificationsIndex({
    ...
    useEffect(() => {
        const timer = setTimeout(() => {
            if (searchQuery !== (filters.search || '')) {
                router.get(
                    route('admin.notifications.push.index'),
    ...
    return (
        <AdminLayout title="Push Bildirimleri">
            <Head title="Push Bildirimleri" />

            <div className="space-y-6">
                <AdminPageHeader
                    title="Push Bildirimleri"
                    description="Gönderilen anlık bildirimlerin listesi."
                    actionHref="/admin/bildirimler/push/yeni"
                    actionLabel="Yeni Bildirim Gönder"
                />
                            ...
                            <tbody className="divide-y divide-gray-200 bg-white">
                                {notifications.map((notification) => (
                                    ...
                                    >
                                        <td className="px-6 py-4 text-sm font-medium text-gray-900">
                                            ...
                                            <div className="mt-0.5 max-w-md truncate text-xs font-normal text-gray-500">
                                ...
                                {notifications.length === 0 && (
                                    <tr>
                                        ...
                                        >
                                            Henüz gönderilmiş bi push bildirimi
                                            bulunmuyor.
                                        </td>
                                    </tr>
                                )}

...
type PushCreateProps = {
    users: User[];
    offices: Office[];
};

export default function PushCreate({ users, offices }: PushCreateProps) {
    ...
    const submit = (e: React.FormEvent) => {
        e.preventDefault();
        post(route('admin.notifications.push.store'));
    };
    ...
    return (
        <AdminLayout title="Yeni Push Bildirim">
            <Head title="Yeni Push Bildirim" />

            <form onSubmit={submit} className="space-y-6">
                <AdminFormHeader
                    title="Yeni Push Bildirim"
                    description="Kullanıcılara veya ofislere anlık bildirim gönderin."
                    submitLabel="Gönder"
                    cancelHref="/admin/bildirimler/push"
